            ...
            <div class="card">
                ...
                <div class="comment-widgets m-b-20">
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{{ $comment->user->profile->profileImage() }}" alt="user" width="50"></span>
                    </div>
                        <div class="comment-text w-100">
                            ...
                            <div class="comment-footer">
                                ...
                                @can('delete', $comment)
                                    <span><a href="/c/{{ $comment->id }}/d" data-abc="true"><i class="fa fa-trash" aria-hidden="true"></i></a><span>
                                @endcan
                            </div>
